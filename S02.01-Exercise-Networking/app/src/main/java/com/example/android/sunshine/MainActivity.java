...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        makePreferredLocationWeatherQuery();
    }
    ...
    private void makePreferredLocationWeatherQuery() {
        String locationQuery = SunshinePreferences.PREF_CITY_NAME;
        URL locationUrl = NetworkUtils.buildUrl((locationQuery));
