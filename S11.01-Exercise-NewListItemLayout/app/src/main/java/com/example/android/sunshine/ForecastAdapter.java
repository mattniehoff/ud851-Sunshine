...
//      COMPLETE (7) Replace the single TextView with Views to display all of the weather info
        ...
        forecastAdapterViewHolder.dateString.setText(dateString);
...
//          COMPLETE (6) Get references to all new views and delete this line
            dateString = (TextView) view.findViewById(R.id.tv_date_string);
            weatherDescription = (TextView) view.findViewById(R.id.tv_weather_description);
            highTemp = (TextView) view.findViewById(R.id.tv_high_temp);
            lowTemp = (TextView) view.findViewById(R.id.tv_low_temp);
